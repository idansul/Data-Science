...
<style>
body {
background-image: url("https://i.postimg.cc/FHTcsC2j/image.png");
...
st.write("""The data set includes descriptions of hypothetical samples corresponding to 23 species of gilled mushrooms in the Agaricus and Lepiota families.
         The app is based on 3 ML models that I built. The code can be found in my [Github](https://github.com/idansul/data_science/tree/main/mushroom_project).""")
...
features = {"cap-shape": {"b": "bell", "c": "conical", "x": "convex", "f": "flat", "k": "knobbed", "s": "sunken"},
            ...
            "stalk-color-above-ring": {"n": "brown", "b": "buff", "g": "gray", "p": "pink", "e": "red", "w": "white", "y": "yellow"},
...
credit = st.beta_columns([2.2, 0.75])
